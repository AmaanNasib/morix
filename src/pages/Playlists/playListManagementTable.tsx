...
import { playListColumns } from "./playListColumnConfig";
...
import { playListManagementData } from "@/data/jsonData";
// import { playListColumns } from "@/data/tableData";
...
export const PlaylistManagementTable = ({ }: PlaylistManagementTableProps) => {
    ...
    const {
        ...
        filterValue,
    } = useTableControls(playListManagementData, playListManagementData.length);
    ...
    const fetchData = useCallback(
        async (searchQuery: string = '', searchPage: number) => {
            try {
                ...
                setLicenseData(playListManagementData);
                if (search) {
                    const filteredData = playListManagementData.filter((item: any) =>
